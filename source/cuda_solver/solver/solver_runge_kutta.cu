...
void PC3::Solver::iterateFixedTimestepRungeKutta( bool evaluate_pulse, dim3 block_size, dim3 grid_size ) {
    ...
    CALL_KERNEL(
        ...
        system.t, device_pointers, current_system_parameters,
        { 
    ...
    if (evaluate_pulse)
        CALL_KERNEL(
            ...
            system.t, current_system_parameters, pulse_pointers, system.use_te_tm_splitting,
            { 
                device_pointers.wavefunction_plus, device_pointers.wavefunction_minus, device_pointers.reservoir_plus, device_pointers.reservoir_minus,
                device_pointers.k1_wavefunction_plus, device_pointers.k1_wavefunction_minus, device_pointers.k1_reservoir_plus, device_pointers.k1_reservoir_minus
            }
    ...
    CALL_KERNEL(
        ...
        system.t + 0.5*system.dt, device_pointers, current_system_parameters,
        { 
    ...
    if (evaluate_pulse)
        CALL_KERNEL(
            ...
            system.t + 0.5*system.dt, current_system_parameters, pulse_pointers, system.use_te_tm_splitting,
            { 
                device_pointers.buffer_wavefunction_plus, device_pointers.buffer_wavefunction_minus, device_pointers.buffer_reservoir_plus, device_pointers.buffer_reservoir_minus,
                device_pointers.k2_wavefunction_plus, device_pointers.k2_wavefunction_minus, device_pointers.k2_reservoir_plus, device_pointers.k2_reservoir_minus
            }
    ...
    CALL_KERNEL(
        ...
        system.t + system.dt, device_pointers, current_system_parameters,
        { 
            device_pointers.buffer_wavefunction_plus, device_pointers.buffer_wavefunction_minus, device_pointers.buffer_reservoir_plus, device_pointers.buffer_reservoir_minus,
    ...
    if (evaluate_pulse)
        CALL_KERNEL(
            ...
            system.t + system.dt, current_system_parameters, pulse_pointers, system.use_te_tm_splitting,
            { 
                device_pointers.buffer_wavefunction_plus, device_pointers.buffer_wavefunction_minus, device_pointers.buffer_reservoir_plus, device_pointers.buffer_reservoir_minus,
                device_pointers.k4_wavefunction_plus, device_pointers.k4_wavefunction_minus, device_pointers.k4_reservoir_plus, device_pointers.k4_reservoir_minus
            }
...
void PC3::Solver::iterateVariableTimestepRungeKutta( bool evaluate_pulse, dim3 block_size, dim3 grid_size ) {
    ...
    do {
        ...
        CALL_KERNEL(
            RUNGE_FUNCTION, "K2", grid_size, block_size, 
            system.t + RKCoefficients::a2 * system.dt, device_pointers, current_system_parameters,
            { 
                device_pointers.buffer_wavefunction_plus, device_pointers.buffer_wavefunction_minus, device_pointers.buffer_reservoir_plus, device_pointers.buffer_reservoir_minus,
                device_pointers.k2_wavefunction_plus, device_pointers.k2_wavefunction_minus, device_pointers.k2_reservoir_plus, device_pointers.k2_reservoir_minus
            }
        ...
        CALL_KERNEL(
            RUNGE_FUNCTION, "K3", grid_size, block_size, 
            system.t + RKCoefficients::a3 * system.dt, device_pointers, current_system_parameters,
            { 
                device_pointers.buffer_wavefunction_plus, device_pointers.buffer_wavefunction_minus, device_pointers.buffer_reservoir_plus, device_pointers.buffer_reservoir_minus,
                device_pointers.k3_wavefunction_plus, device_pointers.k3_wavefunction_minus, device_pointers.k3_reservoir_plus, device_pointers.k3_reservoir_minus
            }
        ...
        CALL_KERNEL(
            RUNGE_FUNCTION, "K4", grid_size, block_size, 
            system.t + RKCoefficients::a4 * system.dt, device_pointers, current_system_parameters,
            { 
                device_pointers.buffer_wavefunction_plus, device_pointers.buffer_wavefunction_minus, device_pointers.buffer_reservoir_plus, device_pointers.buffer_reservoir_minus,
                device_pointers.k4_wavefunction_plus, device_pointers.k4_wavefunction_minus, device_pointers.k4_reservoir_plus, device_pointers.k4_reservoir_minus
            }
        ...
        CALL_KERNEL(
            ...
            system.t + RKCoefficients::a5 * system.dt, device_pointers, current_system_parameters,
            { 
                device_pointers.buffer_wavefunction_plus, device_pointers.buffer_wavefunction_minus, device_pointers.buffer_reservoir_plus, device_pointers.buffer_reservoir_minus,
        ...
        CALL_KERNEL(
            ...
            system.t + RKCoefficients::a6 * system.dt, device_pointers, current_system_parameters,
            { 
                device_pointers.buffer_wavefunction_plus, device_pointers.buffer_wavefunction_minus, device_pointers.buffer_reservoir_plus, device_pointers.buffer_reservoir_minus,
        ...
        CALL_KERNEL(
            ...
            system.t + RKCoefficients::a7 * system.dt, device_pointers, current_system_parameters,
            { 
                device_pointers.buffer_wavefunction_plus, device_pointers.buffer_wavefunction_minus, device_pointers.buffer_reservoir_plus, device_pointers.buffer_reservoir_minus,
...
bool PC3::Solver::iterateRungeKutta( ) {
    ...
    dim3 grid_size( (system.s_N*system.s_N + block_size.x - 1) / block_size.x, 1 );
    
    //std::cout << "Launching a maximum of " << grid_size.x * grid_size.y * block_size.x * block_size.y << " threads." << std::endl;
