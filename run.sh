...
time ./main.o --L 200 200 --tmax 200 --gammaC 0.01 --gc 6E-6 --gr 12E-6 --initRandom 0.01 random --tmax 100 --outEvery 500000 --threads $OMP_NUM_THREADS --path output --N $1 $1 --output none --fftEvery 100000 #--boundary periodic periodic
